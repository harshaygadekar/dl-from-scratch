...
> Goal: Implement append/read KV cache primitives and cached attention step for autoregressive decoding.
...
1. Implement core primitives for KV Cache Optimization in pure NumPy.
...
Focus area for this topic: cache length bookkeeping and slice correctness.

---

## Problem Statement

Build a complete, testable implementation path for KV Cache Optimization across solution tiers:
...
- init_kv_cache, append_kv, current_kv, cached_attention_step
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 31'
...
Continue to Topic 32 after passing all tests at this topic.
