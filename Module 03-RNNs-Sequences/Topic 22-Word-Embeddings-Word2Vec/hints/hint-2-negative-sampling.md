...
Negative sampling approximates full softmax by contrasting positives against sampled negatives.
...
Continue with [Hint 3 - Subsampling](hint-3-subsampling.md) after you can pass the quick checks below.
