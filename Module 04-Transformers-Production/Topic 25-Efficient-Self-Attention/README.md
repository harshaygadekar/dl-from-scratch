...
> Goal: Implement scaled dot-product self-attention with causal masking and stable softmax.
...
1. Implement core primitives for Efficient Self Attention in pure NumPy.
...
Focus area for this topic: QK^T scaling, mask broadcast, and probability normalization.

---

## Problem Statement

Build a complete, testable implementation path for Efficient Self Attention across solution tiers:
...
- scaled_dot_product_attention, causal_mask, chunked_attention_scores
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 25'
...
Continue to Topic 26 after passing all tests at this topic.
