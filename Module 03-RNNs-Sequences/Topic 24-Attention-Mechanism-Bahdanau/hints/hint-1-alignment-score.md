...
Alignment scores compare decoder state with each encoder state before normalization.
...
Continue with [Hint 2 - Context Vector](hint-2-context-vector.md) after you can pass the quick checks below.
