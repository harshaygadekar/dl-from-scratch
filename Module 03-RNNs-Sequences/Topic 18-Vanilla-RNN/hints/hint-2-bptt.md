...
Build a sequence model by unrolling recurrent updates over time and training with stable gradients.

## Core Idea

Backpropagation through time accumulates gradients across all unrolled steps in reverse temporal order.
...
Continue with [Hint 3 - Gradient Clipping](hint-3-gradient-clipping.md) after you can pass the quick checks below.
