# Topic 32: Modern Optimizations

> Goal: Implement practical optimization utilities: segmentation, checkpoint planning, and blockwise score computation.
...
1. Implement core primitives for Modern Optimizations in pure NumPy.
...
Focus area for this topic: block coverage and memory/compute trade-off accounting.

---

## Problem Statement

Build a complete, testable implementation path for Modern Optimizations across solution tiers:
...
- split_segments, checkpoint_plan, blockwise_qk_scores, activation_memory_bytes
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 32'
...
Continue to Topic 33 after passing all tests at this topic.
