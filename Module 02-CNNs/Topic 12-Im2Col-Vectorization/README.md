...
> Goal: Implement im2col extraction and matrix-multiply convolution that matches sliding-window semantics exactly.
...
1. Implement core primitives for Im2Col Vectorization in pure NumPy.
...
Focus area for this topic: column ordering, stride/padding offsets, and NCHW reshape-back correctness.

---

## Problem Statement

Build a complete, testable implementation path for Im2Col Vectorization across solution tiers:
...
- im2col_naive, conv2d_im2col_naive
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 12'
...
Continue to Topic 13 after passing all tests at this topic.
