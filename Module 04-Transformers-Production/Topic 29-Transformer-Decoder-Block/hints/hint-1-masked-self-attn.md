...
Decoder self-attention must always apply causal masking on target positions.
...
Continue with [Hint 2 - Cross Attention](hint-2-cross-attn.md) after you can pass the quick checks below.
