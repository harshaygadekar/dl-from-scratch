...
GRU update gate interpolates between previous hidden state and candidate state.
...
Continue with [Hint 2 - Reset Gate](hint-2-reset-gate.md) after you can pass the quick checks below.
