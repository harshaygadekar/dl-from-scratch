...
Learn dense token vectors using local context objectives and efficient negative examples.

## Core Idea

Embedding lookup is indexed gather; verify vocab bounds and shape conventions first.
...
Continue with [Hint 2 - Negative Sampling](hint-2-negative-sampling.md) after you can pass the quick checks below.
