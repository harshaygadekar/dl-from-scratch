...
LSTM gate equations must use consistent affine transforms and activation functions per gate.
...
Continue with [Hint 2 - Cell State](hint-2-cell-state.md) after you can pass the quick checks below.
