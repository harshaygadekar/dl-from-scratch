...
LayerNorm placement must be consistent across attention and FFN sublayers.
...
Continue with [Hint 3 - FFN Shapes](hint-3-ffn-shapes.md) after you can pass the quick checks below.
