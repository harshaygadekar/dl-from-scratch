...
Next-token loss aligns logits[t] with target[t+1] after shifting.
...
Continue with [Hint 3 - Generation Loop](hint-3-generation-loop.md) after you can pass the quick checks below.
