...
Bidirectional RNNs run separate forward and backward streams that are merged per timestep.
...
Continue with [Hint 2 - Padding Mask](hint-2-padding-mask.md) after you can pass the quick checks below.
