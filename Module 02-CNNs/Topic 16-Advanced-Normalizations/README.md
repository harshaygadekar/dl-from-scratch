...
> Goal: Implement LayerNorm, GroupNorm, and InstanceNorm with axis-aware statistics.
...
1. Implement core primitives for Advanced Normalizations in pure NumPy.
...
Focus area for this topic: normalization axes, epsilon handling, and per-sample consistency.

---

## Problem Statement

Build a complete, testable implementation path for Advanced Normalizations across solution tiers:
...
- layer_norm_nchw, group_norm_nchw, instance_norm_nchw
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 16'
...
Continue to Topic 17 after passing all tests at this topic.
