...
Depthwise convolution applies one spatial kernel per input channel without channel mixing.
...
Continue with [Hint 2 - Pointwise](hint-2-pointwise.md) after you can pass the quick checks below.
