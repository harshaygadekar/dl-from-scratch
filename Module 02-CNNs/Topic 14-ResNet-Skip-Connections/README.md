...
> Goal: Build residual blocks with identity/projection shortcuts and verify residual addition invariants.
...
1. Implement core primitives for ResNet Skip Connections in pure NumPy.
...
Focus area for this topic: shortcut shape compatibility and stable residual merge.

---

## Problem Statement

Build a complete, testable implementation path for ResNet Skip Connections across solution tiers:
...
- residual_block_forward, projection_shortcut
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 14'
...
Continue to Topic 15 after passing all tests at this topic.
