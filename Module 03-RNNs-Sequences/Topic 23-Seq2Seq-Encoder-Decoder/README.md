...
> Goal: Implement seq2seq encoder-decoder flow with teacher forcing control.
...
1. Implement core primitives for Seq2Seq Encoder Decoder in pure NumPy.
...
Focus area for this topic: encoder context transfer and decoder step bookkeeping.

---

## Problem Statement

Build a complete, testable implementation path for Seq2Seq Encoder Decoder across solution tiers:
...
- encoder_forward, decoder_step, seq2seq_forward
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 23'
...
Continue to Topic 24 after passing all tests at this topic.
