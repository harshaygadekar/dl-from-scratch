...
Build residual blocks that improve optimization while preserving shape and signal flow.

## Core Idea

Use projection shortcuts when channels or stride differ so both residual branches have aligned shapes.
...
Continue with [Hint 3 - Residual Stability](hint-3-residual-stability.md) after you can pass the quick checks below.
