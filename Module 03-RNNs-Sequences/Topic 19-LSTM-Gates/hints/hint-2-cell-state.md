...
Implement gated recurrent dynamics that control memory write, keep, and read operations.

## Core Idea

Cell state is the long-term memory path; verify forget and input contributions each step.
...
Continue with [Hint 3 - Backward Flow](hint-3-backward-flow.md) after you can pass the quick checks below.
