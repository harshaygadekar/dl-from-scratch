...
Process sequences in both directions and correctly ignore padding tokens during compute and loss.

## Core Idea

Mask padded tokens so they do not contribute to attention, pooling, or loss terms.
...
Continue with [Hint 3 - Packed Sequence Logic](hint-3-packed-sequence-logic.md) after you can pass the quick checks below.
