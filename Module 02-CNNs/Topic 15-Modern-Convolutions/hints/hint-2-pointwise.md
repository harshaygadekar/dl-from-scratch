...
Implement efficient convolution variants used in modern CNNs (depthwise, pointwise, dilated).

## Core Idea

Pointwise (1x1) convolution mixes channels at each spatial location and often follows depthwise layers.
...
Continue with [Hint 3 - Dilated](hint-3-dilated.md) after you can pass the quick checks below.
