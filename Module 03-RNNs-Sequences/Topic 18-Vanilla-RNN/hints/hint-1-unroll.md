...
Unroll recurrence across time so each step consumes current input and previous hidden state.
...
Continue with [Hint 2 - BPTT](hint-2-bptt.md) after you can pass the quick checks below.
