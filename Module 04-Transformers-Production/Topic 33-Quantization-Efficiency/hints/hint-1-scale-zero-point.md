...
Quantization scale and zero-point determine mapping from float to integer bins.
...
Continue with [Hint 2 - Fake Quant](hint-2-fake-quant.md) after you can pass the quick checks below.
