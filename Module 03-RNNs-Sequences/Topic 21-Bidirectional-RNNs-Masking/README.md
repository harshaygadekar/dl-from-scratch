...
> Goal: Implement bidirectional recurrence and masking for variable-length batches.
...
1. Implement core primitives for Bidirectional RNNs Masking in pure NumPy.
...
Focus area for this topic: forward/backward stream merge and padding-mask correctness.

---

## Problem Statement

Build a complete, testable implementation path for Bidirectional RNNs Masking across solution tiers:
...
- bidirectional_rnn_forward, apply_sequence_mask
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 21'
...
Continue to Topic 22 after passing all tests at this topic.
