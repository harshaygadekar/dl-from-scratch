# Hint 2: Cross Attention

## Goal In This Hint

Compose masked self-attention, cross-attention, and FFN for autoregressive decoding.

## Core Idea

Cross-attention uses decoder queries against encoder keys/values; check source-target length axes.
...
Continue with [Hint 3 - Autoregressive Step](hint-3-autoregressive-step.md) after you can pass the quick checks below.
