...
Reliable training starts with deterministic loading, normalization, augmentation order, and label handling.
...
Continue with [Hint 2 - Model Baseline](hint-2-model-baseline.md) after you can pass the quick checks below.
