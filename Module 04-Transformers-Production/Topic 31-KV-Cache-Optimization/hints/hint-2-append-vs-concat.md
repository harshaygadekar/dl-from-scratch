...
Cache past keys/values to avoid recomputing full attention during incremental decoding.

## Core Idea

Repeated concat can be expensive; prefer preallocation or append-then-stack patterns.
...
Continue with [Hint 3 - Correctness Check](hint-3-correctness-check.md) after you can pass the quick checks below.
