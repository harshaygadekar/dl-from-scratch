...
Store argmax locations per window so backward pass routes gradients to the exact winning element.
...
Continue with [Hint 2 - Avg Pool](hint-2-avg-pool.md) after you can pass the quick checks below.
