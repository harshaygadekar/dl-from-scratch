...
Implement GRU gating logic with fewer parameters than LSTM while preserving sequence modeling power.

## Core Idea

GRU reset gate controls how much past state contributes to candidate computation.
...
Continue with [Hint 3 - Parameter Efficiency](hint-3-parameter-efficiency.md) after you can pass the quick checks below.
