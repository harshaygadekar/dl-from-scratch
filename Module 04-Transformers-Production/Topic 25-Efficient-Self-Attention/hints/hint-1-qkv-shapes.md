...
Q, K, V shape discipline is critical; write exact dimensions for every projection and transpose.
...
Continue with [Hint 2 - Causal Mask](hint-2-causal-mask.md) after you can pass the quick checks below.
