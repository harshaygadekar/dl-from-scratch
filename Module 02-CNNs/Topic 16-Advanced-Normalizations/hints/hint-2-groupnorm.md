...
GroupNorm normalizes channel groups; verify group partitioning and reshape logic carefully.
...
Continue with [Hint 3 - InstanceNorm](hint-3-instancenorm.md) after you can pass the quick checks below.
