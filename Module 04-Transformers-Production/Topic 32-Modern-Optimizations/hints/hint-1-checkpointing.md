...
Activation checkpointing trades compute for memory; verify recompute path determinism.
...
Continue with [Hint 2 - Attention Tiling](hint-2-attention-tiling.md) after you can pass the quick checks below.
