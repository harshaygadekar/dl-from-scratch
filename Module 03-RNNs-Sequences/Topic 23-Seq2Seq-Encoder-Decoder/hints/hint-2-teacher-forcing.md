# Hint 2: Teacher Forcing

## Goal In This Hint

Connect encoder and decoder loops for conditional generation over variable-length sequences.

## Core Idea

Teacher forcing feeds ground-truth tokens during training to stabilize early decoder learning.
...
Continue with [Hint 3 - Decoder Loop](hint-3-decoder-loop.md) after you can pass the quick checks below.
