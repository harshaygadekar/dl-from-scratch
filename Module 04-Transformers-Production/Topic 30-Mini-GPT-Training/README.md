...
> Goal: Build a minimal char-level GPT-style training scaffold with batching, loss, and generation loops.
...
1. Implement core primitives for Mini GPT Training in pure NumPy.
...
Focus area for this topic: next-token target alignment and sampling stability.

---

## Problem Statement

Build a complete, testable implementation path for Mini GPT Training across solution tiers:
...
- make_batches, cross_entropy_from_logits, bigram_forward, generate_bigram
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 30'
...
Continue to Topic 31 after passing all tests at this topic.
