...
> Goal: Implement LSTM gate equations and cell-state flow with stable forward/backward behavior.
...
1. Implement core primitives for LSTM Gates in pure NumPy.
...
Focus area for this topic: gate ordering, sigmoid/tanh application points, and cell-state persistence.

---

## Problem Statement

Build a complete, testable implementation path for LSTM Gates across solution tiers:
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 19'
...
Continue to Topic 20 after passing all tests at this topic.
