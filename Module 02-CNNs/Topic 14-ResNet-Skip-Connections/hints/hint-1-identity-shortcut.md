...
Identity shortcuts require exact shape match so residual addition is element-wise and lossless.
...
Continue with [Hint 2 - Projection Shortcut](hint-2-projection-shortcut.md) after you can pass the quick checks below.
