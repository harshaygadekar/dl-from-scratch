...
> Goal: Implement max/avg pooling forward logic plus vectorized variants that preserve correctness under stride.
...
1. Implement core primitives for Pooling Strides in pure NumPy.
...
Focus area for this topic: window boundaries, max-mask tracking, and stride-aligned indexing.

---

## Problem Statement

Build a complete, testable implementation path for Pooling Strides across solution tiers:
...
- max_pool2d_forward, avg_pool2d_forward, max_pool2d_vectorized
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 13'
...
Continue to Topic 14 after passing all tests at this topic.
