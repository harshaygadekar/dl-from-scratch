...
Extract every KxK receptive field in a fixed order so each window maps to exactly one output location.
...
Continue with [Hint 2 - Column Layout](hint-2-column-layout.md) after you can pass the quick checks below.
