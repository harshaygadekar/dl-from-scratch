...
> Goal: Implement a vanilla RNN unroll and hidden-state transition across time steps.
...
1. Implement core primitives for Vanilla RNN in pure NumPy.
...
Focus area for this topic: time-axis iteration, hidden-state carry, and gradient clipping hooks.

---

## Problem Statement

Build a complete, testable implementation path for Vanilla RNN across solution tiers:
...
- rnn_step, rnn_forward, clip_grad_norm
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 18'
...
Continue to Topic 19 after passing all tests at this topic.
