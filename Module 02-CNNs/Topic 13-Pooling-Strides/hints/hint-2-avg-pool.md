...
Implement pooling operators that reduce spatial size while preserving correct gradient flow for max pooling.

## Core Idea

Average pooling should divide by window area consistently and preserve dtype behavior across implementations.
...
Continue with [Hint 3 - Backward Pass](hint-3-backward-pass.md) after you can pass the quick checks below.
