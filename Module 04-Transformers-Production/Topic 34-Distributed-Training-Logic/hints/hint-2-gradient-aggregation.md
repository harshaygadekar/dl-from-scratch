...
Aggregation must preserve scale (sum vs mean) consistently with learning-rate assumptions.
...
Continue with [Hint 3 - Sync Costs](hint-3-sync-costs.md) after you can pass the quick checks below.
