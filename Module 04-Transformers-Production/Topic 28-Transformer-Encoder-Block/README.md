...
> Goal: Assemble full encoder block: attention, residual, layer norm, and feed-forward sublayers.
...
1. Implement core primitives for Transformer Encoder Block in pure NumPy.
...
Focus area for this topic: operation ordering and residual stability.

---

## Problem Statement

Build a complete, testable implementation path for Transformer Encoder Block across solution tiers:
...
- encoder_block_forward, layer_norm, chunked_ffn
...
4. Validate full topic through the runner:
   'python3 utils/test_runner.py --day 28'
...
Continue to Topic 29 after passing all tests at this topic.
