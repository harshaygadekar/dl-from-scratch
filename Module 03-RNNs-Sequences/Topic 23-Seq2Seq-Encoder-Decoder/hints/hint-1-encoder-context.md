...
Encoder context summarizes source sequence information for decoder initialization or attention.
...
Continue with [Hint 2 - Teacher Forcing](hint-2-teacher-forcing.md) after you can pass the quick checks below.
