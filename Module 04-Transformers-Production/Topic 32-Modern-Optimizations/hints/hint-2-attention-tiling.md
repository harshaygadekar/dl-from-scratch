...
Apply memory and throughput optimizations while keeping training numerics correct.

## Core Idea

Tiling attention reduces peak memory by computing blocks and accumulating partial results.
...
Continue with [Hint 3 - Memory Throughput](hint-3-memory-throughput.md) after you can pass the quick checks below.
